...
#define TILE_ACTION(o) \
  (G_TYPE_CHECK_INSTANCE_CAST((o), TILE_ACTION_TYPE, TileAction))
#define TILE_ACTION_CLASS(c) \
  (G_TYPE_CHECK_CLASS_CAST((c), TILE_ACTION_TYPE, TileActionClass))
...
#define TILE_ACTION_GET_CLASS(o) \
  (G_TYPE_INSTANCE_GET_CLASS((o), TILE_ACTION_TYPE, TileActionClass))
#define TILE_ACTION_CHECK_FLAG(action, flag) \
  ((TILE_ACTION(action)->flags & (flag)) != 0)
