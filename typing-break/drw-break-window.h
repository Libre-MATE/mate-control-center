...
#define DRW_BREAK_WINDOW(o) \
  (G_TYPE_CHECK_INSTANCE_CAST((o), DRW_TYPE_BREAK_WINDOW, DrwBreakWindow))
#define DRW_BREAK_WINDOW_CLASS(k) \
  (G_TYPE_CHECK_CLASS_CAST((k), DRW_TYPE_BREAK_WINDOW, DrwBreakWindowClass))
#define DRW_IS_BREAK_WINDOW(o) \
  (G_TYPE_CHECK_INSTANCE_TYPE((o), DRW_TYPE_BREAK_WINDOW))
#define DRW_IS_BREAK_WINDOW_CLASS(k) \
  (G_TYPE_CHECK_CLASS_TYPE((k), DRW_TYPE_BREAK_WINDOW))
#define DRW_BREAK_WINDOW_GET_CLASS(o) \
  (G_TYPE_INSTANCE_GET_CLASS((o), DRW_TYPE_BREAK_WINDOW, DrwBreakWindowClass))
