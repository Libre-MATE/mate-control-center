...
#define BOOKMARK_AGENT(o) \
  (G_TYPE_CHECK_INSTANCE_CAST((o), BOOKMARK_AGENT_TYPE, BookmarkAgent))
#define BOOKMARK_AGENT_CLASS(c) \
  (G_TYPE_CHECK_CLASS_CAST((c), BOOKMARK_AGENT_TYPE, BookmarkAgentClass))
#define IS_BOOKMARK_AGENT(o) \
  (G_TYPE_CHECK_INSTANCE_TYPE((o), BOOKMARK_AGENT_TYPE))
#define IS_BOOKMARK_AGENT_CLASS(c) \
  (G_TYPE_CHECK_CLASS_TYPE((c), BOOKMARK_AGENT_TYPE))
#define BOOKMARK_AGENT_GET_CLASS(o) \
  (G_TYPE_INSTANCE_GET_CLASS((o), BOOKMARK_AGENT_TYPE, BookmarkAgentClass))
