...
#define FOO_SCROLL_AREA(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), FOO_TYPE_SCROLL_AREA, FooScrollArea))
#define FOO_SCROLL_AREA_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass), FOO_TYPE_SCROLL_AREA, FooScrollAreaClass))
#define FOO_IS_SCROLL_AREA(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), FOO_TYPE_SCROLL_AREA))
#define FOO_IS_SCROLL_AREA_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), FOO_TYPE_SCROLL_AREA))
#define FOO_SCROLL_AREA_GET_CLASS(obj) \
  (G_TYPE_INSTANCE_GET_CLASS((obj), FOO_TYPE_SCROLL_AREA, FooScrollAreaClass))
...
struct FooScrollAreaClass {
  ...
  void (*paint)(FooScrollArea *scroll_area, cairo_t *cr, GdkRectangle *extents,
...
void foo_scroll_area_set_viewport_pos(FooScrollArea *scroll_area, int x, int y);
