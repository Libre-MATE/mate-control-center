...
#define SHELL_WINDOW(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), SHELL_WINDOW_TYPE, ShellWindow))
#define SHELL_WINDOW_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass), SHELL_WINDOW_TYPE, ShellWindowClass))
#define IS_SHELL_WINDOW(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), SHELL_WINDOW_TYPE))
#define IS_SHELL_WINDOW_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), SHELL_WINDOW_TYPE))
#define SHELL_WINDOW_GET_CLASS(obj) \
  (G_TYPE_CHECK_GET_CLASS((obj), SHELL_WINDOW_TYPE, ShellWindowClass))
