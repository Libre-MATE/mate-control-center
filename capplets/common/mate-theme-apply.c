...
void mate_meta_theme_set(MateThemeMetaInfo *meta_theme_info) {
  ...
  if (compare(old_key, meta_theme_info->gtk_theme_name)) {
    g_settings_set_string(interface_settings, GTK_THEME_KEY,
  ...
  /* Set the wm key */
  g_settings_set_string(marco_settings, MARCO_THEME_KEY,
  ...
  if (compare(old_key, meta_theme_info->icon_theme_name)) {
    g_settings_set_string(interface_settings, ICON_THEME_KEY,
  ...
  if (notification_settings != NULL) {
    if (meta_theme_info->notification_theme_name != NULL) {
      ...
      if (compare(old_key, meta_theme_info->notification_theme_name)) {
        g_settings_set_string(notification_settings, NOTIFICATION_THEME_KEY,
  ...
  if (compare(old_key, meta_theme_info->cursor_theme_name)) {
    g_settings_set_string(mouse_settings, CURSOR_THEME_KEY,
  ...
  if (old_key_int != meta_theme_info->cursor_size) {
    g_settings_set_int(mouse_settings, CURSOR_SIZE_KEY,
