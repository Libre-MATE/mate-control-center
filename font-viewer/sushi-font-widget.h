...
#define SUSHI_FONT_WIDGET(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), SUSHI_TYPE_FONT_WIDGET, SushiFontWidget))
#define SUSHI_IS_FONT_WIDGET(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), SUSHI_TYPE_FONT_WIDGET))
#define SUSHI_FONT_WIDGET_CLASS(klass)                      \
  (G_TYPE_CHECK_CLASS_CAST((klass), SUSHI_TYPE_FONT_WIDGET, \
                           SushiFontWidgetClass))
#define SUSHI_IS_FONT_WIDGET_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), SUSHI_TYPE_FONT_WIDGET))
#define SUSHI_FONT_WIDGET_GET_CLASS(obj)                    \
  (G_TYPE_INSTANCE_GET_CLASS((obj), SUSHI_TYPE_FONT_WIDGET, \
                             SushiFontWidgetClass))
