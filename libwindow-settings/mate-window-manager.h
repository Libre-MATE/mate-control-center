...
typedef enum {
  ...
  MATE_WM_SETTING_MASK =
      ...
      MATE_WM_SETTING_AUTORAISE | MATE_WM_SETTING_AUTORAISE_DELAY |
      MATE_WM_SETTING_MOUSE_MOVE_MODIFIER | MATE_WM_SETTING_THEME |
      MATE_WM_SETTING_DOUBLE_CLICK_ACTION |
      MATE_WM_SETTING_COMPOSITING_MANAGER | MATE_WM_SETTING_COMPOSITING_ALTTAB
} MateWMSettingsFlags;
...
#define MATE_WINDOW_MANAGER(obj)                                  \
  G_TYPE_CHECK_INSTANCE_CAST(obj, mate_window_manager_get_type(), \
                             MateWindowManager)
#define MATE_WINDOW_MANAGER_CLASS(klass)                         \
  G_TYPE_CHECK_CLASS_CAST(klass, mate_window_manager_get_type(), \
                          MateWindowManagerClass)
#define IS_MATE_WINDOW_MANAGER(obj) \
  G_TYPE_CHECK_INSTANCE_TYPE(obj, mate_window_manager_get_type())
#define MATE_WINDOW_MANAGER_GET_CLASS(obj)                        \
  (G_TYPE_INSTANCE_GET_CLASS((obj), mate_window_manager_get_type, \
                             MateWindowManagerClass))
...
struct _MateWindowManagerClass {
  ...
  void (*get_settings)(MateWindowManager *wm, MateWMSettings *settings);
