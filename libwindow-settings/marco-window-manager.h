...
#define MARCO_WINDOW_MANAGER(obj)                                  \
  G_TYPE_CHECK_INSTANCE_CAST(obj, marco_window_manager_get_type(), \
                             MarcoWindowManager)
#define MARCO_WINDOW_MANAGER_CLASS(klass)                         \
  G_TYPE_CHECK_CLASS_CAST(klass, marco_window_manager_get_type(), \
                          MarcoWindowManagerClass)
#define IS_MARCO_WINDOW_MANAGER(obj) \
  G_TYPE_CHECK_INSTANCE_TYPE(obj, marco_window_manager_get_type())
